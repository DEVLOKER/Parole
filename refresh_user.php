...
function messageEtat($etat, $diff){
	...
	$msg1 =  '
		<div class="alert alert-danger alert-dismissible fade show" role="alert">
		  <strong> '.$_SESSION['service'].' </strong>, désactiver votre microphone S.V.P. <i class="fa fa-microphone-slash" ></i>
	...
	$msg2 = '
		<div class="alert alert-warning fade show" role="alert">
		  ...
		  <h4 class="alert-heading"><strong>'.$_SESSION['service'].'</strong> </h4>
		   <hr>
	...
	$msg3 =  '
		<div class="alert alert-success alert-dismissible fade show" role="alert">
		  <strong>'.$_SESSION['service'].'</strong>, appel en cours... <i class="fas fa-phone-volume" ></i><i class="fas fa-user" ></i> <span class="time"> '.$diff.'</span> </p>
		  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		    <span aria-hidden="true">&times;</span>
		  </button>
		</div>
	...
	$msg4 = '
		<div class="alert alert-secondary fade show" role="alert">
		  <strong>'.$_SESSION['service'].'</strong>, opération términée avec sucsès. <i class="fas fas fa-check" ></i>
		  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
		    <span aria-hidden="true">&times;</span>
		  </button>
		</div>
...
$form = '	<table border="0" cellpadding="10" >
				...
				<form action="ajouter_demande.php" method="post">
					<button '.$damande.' type="submit" class="btn btn-success"><i class="fa fa-microphone" ></i> Demander la parole</button>
				</form>
							</td>
							<td>
				<form action="annuler_demande.php" method="post">
					<button '.$Annuler.' type="submit" class="btn btn-danger"><i class="fas fa-ban" ></i> Annuler la demande</button>
				</form>
							</td>
						</tr>
					</tbody>
